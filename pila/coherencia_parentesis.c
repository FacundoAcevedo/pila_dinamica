...
int main (){
	char* correcto = "Hola (me) llamo (dulce (lauria)) vos que(di((())))";
	char* incorrecto = "Hola (me)) llamo (dulce (lauria)) vos que(di((())))";

	bool coherencia_parentesis(correcto);
	bool coherencia_parentesis(incorrecto);
